...
function RegisterRoomBuilding() {
    ...
    const roomTypeRadioOptions = [
        {
            label: "집 전체",
            value: "entire",
            description: "게스트가 숙소 전체를 다름 사람과 공유하지 않고 단독으로 이용합니다. 일반적으로 침실, 욕실, 부엌이 포함됩니다.",
        },
        {
            label: "개인실",
            value: "private",
    ...
    const onChangeRoomType = (event: string) => {
        const selected = event;
        dispatch(registerRoomActions.setRoomType(selected as "entire" | "public" | "private"));
    };
