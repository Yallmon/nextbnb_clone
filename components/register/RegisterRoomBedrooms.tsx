...
function RegisterRoomBedrooms() {
    const maximumGuestCount = myUseSelector((state) => state.registerRoom.maximumGuestCount);
    const bedroomCount = myUseSelector((state) => state.registerRoom.bedroomCount);
    const bedCount = myUseSelector((state) => state.registerRoom.bedCount);
