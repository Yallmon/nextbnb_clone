...
`; 
function SearchRoomGuests() {
    const [popupOpened, setPopupOpened] = useState(false);

    const adultCount = myUseSelector((state) => state.searchRoom.adultCount);
    const childrenCount = myUseSelector((state) => state.searchRoom.childrenCount);
    const infantsCount = myUseSelector((state) => state.searchRoom.infantsCount);
    ...
    return ( <Container onClick={() => setPopupOpened(true)}>
